...
public class InvoiceRepositoryImpl implements InvoiceRepositoryCustom {
  ...
  /* (非 Javadoc)
   * @see
   * tigers.cave.webm.invoice.dao.repository.custom.InvoiceRepositoryCustom
   * #findByCriteria(tigers.cave.webm.invoice.dao.repository.criteria.InvoiceCriteria)
   */
  @Override
   ...
   * @see
   * tigers.cave.webm.invoice.dao.repository.custom.InvoiceRepositoryCustom
   * #countAllByCriteria(tigers.cave.webm.invoice.dao.repository.criteria.InvoiceCriteria)
   */
  @Override
